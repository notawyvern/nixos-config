...
In [core](./modules/core/) are features for a usable NixOS. It is ethernet only. User crh is declared but mutable. Brazilian Portuguese is enforced. 
...
The file [stylix.nix](./modules/global/stylix.nix) references one. So change the line. The built-in code fetches my wallpaper repo and copies some really nice images to the /nix/store. If you're interested, [take a look](https://github.com/notawyvern/wallpapers).
